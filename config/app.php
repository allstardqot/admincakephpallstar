...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '892f0bb2126206a56e1a1c6fa3f95259873b762f75e2d399bf666105c29dd39b'),
    ],
    /**
    ...
    'EmailTransport' => [
        ...
        'sendgrid' => [
            ...
            'port' => 587,
            'timeout' => 60,
            'username' => 'admin@lfgdraft.com',
            'password' => 'cXJFmw?m-e83%5f',
            'client' => null,
            'tls' => true,
            'auth' => true,
            'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
    ...
    'Datasources' => [
        'default' => [
            ...
            'persistent' => false,
            //'host' => 'real11.chup7khoxwap.us-west-2.rds.amazonaws.com',
			'host' => 'localhost',
            /**
