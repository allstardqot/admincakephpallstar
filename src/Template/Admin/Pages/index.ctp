			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">FAQ Manager</li>
					</ol>
				</div>
			</div>
		</div>
									...
									if(!empty($result)) {
										foreach ($result as $key => $value) { ?>
											<tr>
												...
												<td class="last_td">
													<?php echo $this->Html->link('Edit', ['controller'=>'Pages','action'=>'edit',$value->id],['escape'=>false,'class'=>'btn btn-success',]); ?>
													<?php echo $this->Html->link('View', ['controller'=>'Pages','action'=>'view',$value->id],['escape'=>false,'class'=>'btn btn-info',]); ?>
												</td>
											</tr>
										<?php $start++;
										$i++;
