...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Users Transection</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=SITE_URL?>admin/">Home</a></li>
                        <li class="breadcrumb-item active">List Users Transection</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
								...
								<div class="row ">
									...
									<div class="form-group col-sm-6 col-md-3 ">
										<?php
											...
											echo $this->Html->link('<i class="fa fa-undo"></i>'.__(' Reset'), array('controller' => 'users', 'action' => 'usertransection'), array('class' => 'btn btn-default', 'escape' => false));
										?>
									</div>
                    ...
                    <div class="card-header">
                      <h3 class="card-title" style="display: inline-block;">User Transection</h3>
                      <?php
							...
							<table  class="table  table-bordered responsive" >
								<thead>
									<tr>
										...
										<th>#</th>
										<th><?php echo $this->Paginator->sort('Users.user_name', __('User Name')) ?></th>
										<th><?php echo $this->Paginator->sort('Users.amount', __('Amount')) ?></th>
										<th><?php echo $this->Paginator->sort('Users.type', __('Type')) ?></th>
