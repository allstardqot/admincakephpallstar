						...
						<div class="row">
							<div class="col-md-12">
								<div class="card-body">
									...
									<div class="form-group">
										<?php
											echo $this->Form->input('min_amount',['escape'=>false,'class' => 'form-control','label'=>'Minimum Amount (INR) <span class="required">*</span>', 'placeholder' => __('Minimum Amount'),'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');",'maxlength'=>'10']);
										?>
									...
									<div class="form-group">
										<?php
											$usageLimit	=	($offers->usage_limit == 0) ? 'Unlimited' : $offers->usage_limit;
											$readonly	=	($offers->usage_limit == 0) ? 'readonly' : '';
											$checked	=	($offers->usage_limit == 0) ? 'checked' : '';
											echo $this->Form->input('usage_limit',['escape'=>false,'class' => 'form-control usage_limit','label'=>'Usage Limit <span class="required">*</span>', 'placeholder' => __('Usage Limit'),'type'=>'text','value'=>$usageLimit,$readonly,'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');",'maxlength'=>'10']);
										?>
										<div class="position-relative form-check">
											<input name="check" id="Check_use_limit" type="checkbox" class="form-check-input" <?php echo $checked; ?>>
									...
									<div class="form-group">
										<?php
											$date=	date('Y-m-d H:i:s',strtotime($offers->expiry_date));
											echo $this->Form->input('expiry_date',['escape'=>false,'class' => 'form-control expiry_date','label'=>'Expiry Date <span class="required">*</span>', 'placeholder' => __('Expiry Date'),'type'=>'text','value'=>$date,'readonly']);
										?>
									</div>
									<div class="form-group">
										<?php
