							...
							<div class="col-md-12">
								<div class="card-body">
                                    ...
                                    <div class="form-group">
										...
										<?php
											echo $this->Form->input('profile_image_file',['type'=>'file','class'=>'form-control','label'=>false,'required'=>true]);
										?>
                                        <img class="blogImg" src="<?php echo SITE_URL ?>uploads/blogs/<?php echo $blog->image ?>" alt="">
									</div>
								</div>
							</div>
						</div>
