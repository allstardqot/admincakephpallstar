			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Contents List</li>
					</ol>
				</div>
			</div>
		</div>
									...
									if(!empty($result)) {
										foreach ($result as $key => $value) { ?>
											<tr>
												...
												<td><?php echo !empty($value->content) ? htmlentities(substr($value->content,0,100)) : ''; ?></td>
												<!-- <td>
													<?php
												...
												<td class="last_td">
													<?php echo $this->Html->link('Edit', ['controller'=>'contents','action'=>'edit',$value->id],['escape'=>false,'class'=>'btn btn-success',]); ?>
													<?php echo $this->Html->link('View', ['controller'=>'contents','action'=>'view',$value->id],['escape'=>false,'class'=>'btn btn-info',]); ?>
												</td>
											</tr>
										<?php $start++;
										$i++;
